...
const BUILTIN_ROUTES_CORE: Record<string, ComponentType> = {
  ...
  "/command-deck": CommandDeckOpsPage,
...
export default function App() {
  ...
  const isDeckLayoutRoute = DECK_LAYOUT_ROUTES.has(normalizedPath);
  ...
  return (
    ...
    <div
      ...
      className="deck-app-shell flex h-dvh max-h-dvh min-h-0 flex-col overflow-hidden text-text-primary antialiased"
    >
      <SelectionSwitcher />
      <Backdrop />
      ...
      <header
        className={cn(
          "deck-app-header lg:hidden fixed top-0 left-0 right-0 z-40 min-h-14",
      ...
      >
        ...
        <Typography
          className="font-semibold text-[0.95rem] leading-tight text-[var(--dsd-text-primary)]"
        >
          {t.app.brand}
        </Typography>
      </header>
      ...
      <div className="relative z-[1] flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden pt-14 lg:pt-0">
        <div className="flex min-h-0 min-w-0 flex-1">
          <aside
            ...
            className={cn(
              "deck-sidebar fixed top-0 left-0 z-50 flex h-dvh max-h-dvh w-64 min-h-0 flex-col",
              "transition-[transform] duration-200 ease-out",
              mobileOpen ? "translate-x-0" : "-translate-x-full",
              "lg:sticky lg:top-0 lg:translate-x-0 lg:shrink-0 lg:overflow-hidden",
              "lg:transition-[width] lg:duration-[600ms] lg:ease-[cubic-bezier(0.33,1.35,0.62,1)]",
              isDesktopCollapsed && "is-rail lg:w-14",
            )}
          >
            <div
              className={cn(
                "deck-sidebar-brand flex h-14 shrink-0 items-center gap-2",
                "border-b border-[var(--dsd-border-subtle)]",
            ...
            >
              ...
              >
                ...
                <span className="deck-brand-mark" aria-hidden>
                  HA
                </span>
                <div className="min-w-0">
                  <div className="deck-wordmark">Hermes Agent</div>
                  <div className="deck-tagline">Command Desk</div>
                </div>
              </div>
          ...
          <PageHeaderProvider pluginTabs={pluginTabMeta}>
            <div
              className={cn(
                ...
                isDeckLayoutRoute ? "px-0" : "px-3 sm:px-6",
                isChatRoute
  ...
  return (
    ...
    >
      <button
        ...
        type="button"
        className={cn(
          "deck-system-action group/action relative",
          busy
            ? "text-[var(--dsd-text-primary)]"
            : "text-[var(--dsd-text-secondary)]",
