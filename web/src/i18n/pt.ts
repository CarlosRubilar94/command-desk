...
export const pt: Translations = {
  ...
  ops: {
    ...
    statusWarn: "Atenção necessária",
    homeSubtitle: "Dashboard local :9119 — integrado com Command Deck :8765.",
    operationalLabel: "Estado operacional",
    chatHint: "Abra o chat persistente para rodar o Hermes Agent.",
  },
