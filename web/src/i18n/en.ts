...
export const en: Translations = {
  ...
  ops: {
    ...
    homeSubtitle: "Local dashboard :9119 — integrated with Command Deck :8765.",
    operationalLabel: "Operational status",
    chatHint: "Open the persistent chat to run the Hermes Agent.",
  },
