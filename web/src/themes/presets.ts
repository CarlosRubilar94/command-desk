...
/** Command Deck Ops typography — mirrors control-center/public/tokens.css */
const OPS_TYPOGRAPHY: ThemeTypography = {
  fontSans: `"Segoe UI Variable", "Segoe UI", Inter, ${SYSTEM_SANS}`,
...
const OPS_LAYOUT: ThemeLayout = {
  radius: "0.375rem",
  density: "comfortable",
};

const OPS_COLOR_OVERRIDES = {
  card: "#0C111C",
  ...
  accent: "rgba(125, 211, 252, 0.14)",
  accentForeground: "#E8ECF2",
...
export const commandDeckOpsLargeTheme: DashboardTheme = {
  name: "command-desk-ops-large",
  label: "Command Deck Ops (Large)",
  description: "Ops console with bigger fonts and roomier spacing",
  palette: commandDeckOpsTheme.palette,
  typography: {
    ...OPS_TYPOGRAPHY,
    baseSize: "16px",
    lineHeight: "1.55",
  ...
  terminalBackground: commandDeckOpsTheme.terminalBackground,
  colorOverrides: commandDeckOpsTheme.colorOverrides,
  seriesColors: commandDeckOpsTheme.seriesColors,
  componentStyles: commandDeckOpsTheme.componentStyles,
  swatchColors: commandDeckOpsTheme.swatchColors,
};

/** Themes shown in the picker — exotic presets remain in BUILTIN_THEMES for API compat. */
export const PICKER_THEME_NAMES = new Set([
  "command-desk-ops",
  "command-desk-ops-large",
]);
...
export const defaultTheme: DashboardTheme = {
  ...
  name: "default",
  label: "Command Deck Ops",
  description: commandDeckOpsTheme.description,
};
...
export const BUILTIN_THEMES: Record<string, DashboardTheme> = {
  "command-desk-ops": commandDeckOpsTheme,
  "command-desk-ops-large": commandDeckOpsLargeTheme,
